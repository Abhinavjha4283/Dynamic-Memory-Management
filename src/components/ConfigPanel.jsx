...
function AlgorithmCard({ algo, active, onClick, algoColor }) {
  ...
  return (
    ...
    >
      ...
      <div className="algo-perf-bar">
        <div
          className="algo-perf-fill"
          style={{ width: data.perfWidth, background: data.color }}
        />
      </div>
...
export default function ConfigPanel({
  ...
  const localityClass =
    locality.temporalLocality === 'HIGH'
      ? 'locality-high'
      : locality.temporalLocality === 'MEDIUM'
      ? 'locality-medium'
      : 'locality-low';
      ...
      <div className="panel-section">
        ...
        <div className="frame-control">
          ...
          <div className="frame-stepper">
            <button
              className="frame-stepper-btn"
              onClick={() => onFrameCountChange(Math.max(1, frameCount - 1))}
            ...
            <div className="frame-visual">
              {Array.from({ length: 8 }, (_, i) => (
                <div
                  key={i}
                  className={`frame-visual-dot ${i < frameCount ? 'filled' : ''}`}
                  style={{
                    background: i < frameCount ? algoColor : undefined,
                  }}
                />
              ))}
            </div>
            <button
              className="frame-stepper-btn"
              onClick={() => onFrameCountChange(Math.min(8, frameCount + 1))}
        ...
        <div style={{ marginTop: 16 }}>
          <div className="ref-input-header">
            ...
            <div className="ref-input-actions">
              <button className="ref-action-btn" onClick={onRandom}>
                Random
              </button>
            </div>
          </div>
        ...
        <button
          ...
          style={{
            marginTop: 16,
            background: `linear-gradient(135deg, ${algoColor}, ${algoColor}88)`,
          }}
        >
          ...
          <div className="step-counter">
            ...
            <div className="step-progress">
              <div
                ...
                style={{
                  width: `${progress}%`,
                  background: isComplete ? 'var(--hit)' : algoColor,
                }}
              />
            </div>
          </div>
